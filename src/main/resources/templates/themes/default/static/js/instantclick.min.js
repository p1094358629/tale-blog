var InstantClick = (function(d, r) {
  ...
  function m(Z) {
    ...
    for (var V = R.length - 1; V >= 0; V--) {
      ...
      if (
        Y.target ||
        Y.hasAttribute("download") ||
        Y.href.indexOf(U + "/") != 0 ||
        (Y.href.indexOf("#") > -1 && t(Y.href) == C) ||
        (x ? !P(Y) : M(Y))
      ) {
        continue;
      }
  ...
  var H = (function() {
    ...
    function ab() {
      ...
      ad.innerHTML =
        "#instantclick{position:" +
        (E ? "absolute" : "fixed") +
        ";top:0;left:0;width:100%;pointer-events:none;z-index:2147483647;" +
        ae +
        ":opacity .25s .1s}.instantclick-bar{background:#29d;width:100%;margin-left:-100%;height:2px;" +
        ae +
        ":all .25s}";
  ...
  var i =
    ...
    (!B.match("Android") || B.match("Chrome/")) &&
    r.protocol != "file:";
  function J() {
    if (C) {
      return;
